...
sim.names <- paste0("v00_rep_",stringr::str_pad(1:5,3,pad=0))

for(sim.name in sim.names){
  root.dir <- "~/projects/008_birthrateLandscape/karyotype_evolution/ABM/"
  output.data.dir <- "~/projects/008_birthrateLandscape/karyotype_evolution/ABM/validation/proc_data/"
  output.fig.dir <- "~/projects/008_birthrateLandscape/karyotype_evolution/ABM/validation/figures/"
